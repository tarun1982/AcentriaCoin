...
#   c) node1 mines 32 blocks, so now node 0 has 500000ATC, node 1 has 4250ATC, node2 has none.
#   d) node0 sends 601 ATC to node2, in two transactions (301 ATC, then 300 ATC).
