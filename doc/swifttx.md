...
* WebSocket: [https://github.com/acentriacoin/insight-api-acentriacoin#web-socket-api](https://github.com/acentriacoin/insight-api-acentriacoin#web-socket-api)
* API: [https://github.com/acentriacoin/insight-api-acentriacoin#swifttx-transactions](https://github.com/acentriacoin/insight-api-acentriacoin#swifttx-transactions)
...
By default, the AcentriaCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the AcentriaCoin Core daemon:
