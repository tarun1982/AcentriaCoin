...
Intro
-----
AcentriaCoin (ATC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. AcentriaCoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run acentriacoin-qt.exe.

AcentriaCoin Core is the original AcentriaCoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of AcentriaCoin transactions;
