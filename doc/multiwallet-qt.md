...
In order to support loading of multiple wallets in acentriacoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is acentriacoin.cpp.
...
Changes to acentriacoin.cpp
----------------------
acentriacoin.cpp is the entry point into acentriacoin-qt, and as such, will require some minor modifications to provide hooks for
