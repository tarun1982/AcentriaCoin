Contributing to AcentriaCoin Core
==================================

The AcentriaCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AcentriaCoin Core project, and is not to be
confused with overall AcentriaCoin Network Protocol consensus changes.

Whether a pull request is merged into AcentriaCoin Core rests with the project merge
...
Patches that change AcentriaCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the AcentriaCoin consensus, it must have been
...
The project leader is the release manager for each AcentriaCoin Core release.
