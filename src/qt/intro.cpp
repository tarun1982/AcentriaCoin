...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("AcentriaCoin Core"),
     ...
     * override -datadir in the acentriacoin.conf file in the default data directory
     * (to be consistent with acentriacoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
