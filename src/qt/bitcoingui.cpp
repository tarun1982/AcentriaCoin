                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("AcentriaCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ATC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and acentriacoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About AcentriaCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about AcentriaCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AcentriaCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ATC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ATC addresses"));
    ...
    openAction->setStatusTip(tr("Open a acentriacoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AcentriaCoin Core help message to get a list with possible AcentriaCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("AcentriaCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AcentriaCoin network", "", count));
}
...
{
    QString strTitle = tr("AcentriaCoin Core"); // default title
