...
#if defined(NDEBUG)
#error "AcentriaCoin cannot be compiled without assertions."
#endif
...
{
    RenameThread("acentriacoin-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // ATC: We use certain sporks during IBD, so check to see if they are
