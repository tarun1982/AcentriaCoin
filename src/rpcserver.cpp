...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop AcentriaCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "AcentriaCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AcentriaCoin features */
        {"acentriacoin", "masternode", &masternode, true, true, false},
        {"acentriacoin", "listmasternodes", &listmasternodes, true, true, false},
        {"acentriacoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"acentriacoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"acentriacoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"acentriacoin", "masternodedebug", &masternodedebug, true, true, false},
        {"acentriacoin", "startmasternode", &startmasternode, true, true, false},
        {"acentriacoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"acentriacoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"acentriacoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"acentriacoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"acentriacoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"acentriacoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"acentriacoin", "mnbudget", &mnbudget, true, true, false},
        {"acentriacoin", "preparebudget", &preparebudget, true, true, false},
        {"acentriacoin", "submitbudget", &submitbudget, true, true, false},
        {"acentriacoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"acentriacoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"acentriacoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"acentriacoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"acentriacoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"acentriacoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"acentriacoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"acentriacoin", "checkbudgets", &checkbudgets, true, true, false},
        {"acentriacoin", "mnsync", &mnsync, true, true, false},
        {"acentriacoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> acentriacoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2332/\n";
}
