...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // AcentriaCoin: 1 day
        nTargetSpacing = 2 * 60;  // AcentriaCoin: 2 minutes
        nMaturity = 10;
        ...
        nLastPOWBlock = 200;
        nModifierUpdateBlock = 1; // we use the version 2 for ATC
         ...
         */
        const char* pszTimestamp = "28th March AcentriaCoin Coin initial date, developed by Acentria Tech";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04d10eabb2703ccf322f7dbd62dd5435ac7c10bd055814ce121ba32607d573b8810c02c0582aed05b4deb9c4b77b26d92428c61256cd42774babea0a073b2ed0c9") << OP_CHECKSIG;
        ...
        genesis.nNonce = 1836238;
        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("00000313478884273e44d882b8e5b0f2122ef3dd5ddc67ef07933a904fb52d51"));
        assert(genesis.hashMerkleRoot == uint256("0xe824a3d5392b0754ae03ad1742297aab99eac7cbfcf9ddb93479f336b069f88f"));

        vSeeds.push_back(CDNSSeedData("159.65.228.201", "159.65.228.201"));

        // AcentriaCoin addresses start with 'B'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 25);
        // AcentriaCoin script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 6);
        // AcentriaCoin private keys start with 'K'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 46);
        // AcentriaCoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // AcentriaCoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // AcentriaCoin BIP44 coin type is '222' (0x800000de)
        // BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x00)(0x10)(0xde).convert_to_container<std::vector<unsigned char> >();
        ...
        strSporkKey = "04cc17389379a0e323f53ea504dabcd71f43dc22f597805fed33a51b05ced1a3ae0db84089985f351b3737721736a82f58c8bd529f79c8ffe57e922bda792146ab";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // AcentriaCoin: 1 day
        nTargetSpacing = 2 * 60;  // AcentriaCoin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000313478884273e44d882b8e5b0f2122ef3dd5ddc67ef07933a904fb52d51"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("159.65.228.201", "159.65.228.201"));
        
        // Testnet AcentriaCoin addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 108);
        // Testnet AcentriaCoin script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet AcentriaCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet AcentriaCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // AcentriaCoin: 1 day
        nTargetSpacing = 2 * 60;        // AcentriaCoin: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1521655894;
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 2532;
        assert(hashGenesisBlock == uint256("0x7f5c5adea95b24358baa3bf62c10185454e0d3ea5d70228c0cc02d39559d22e5"));

        vFixedSeeds.clear(); //! Regtest mode doesn't have any fixed seeds.
        vSeeds.clear();      //! Regtest mode doesn't have any DNS seeds.
        vSeeds.push_back(CDNSSeedData("178.238.226.185", "178.238.226.185"));
