...
// Copyright (c) 2017-2018 The AcentriaCoin developers
...
public:
    ...
    /// Is the inputs associated with this public key? (and there is ATC collateral - checking if valid masternode)
